...
static void assign_gs_amm_allocator_only_mode(bool newval, void *extra);
static void assign_gs_amm_feedback_only_mode(bool newval, void *extra);
static void assign_gs_amm_dtree_calibration_enabled(bool newval, void *extra);
static void assign_gs_amm_dtree_record_only(bool newval, void *extra);
static void assign_gs_amm_allocator_only_grant_mb(int newval, void *extra);
static void assign_gs_amm_feedback_config(int newval, void *extra);
...
static const struct config_enum_entry gs_amm_admission_failure_policy_options[] = {
...
static void InitStorageConfigureNamesBool()
{
    struct config_bool localConfigureNamesBool[] = {
        ...
        {{"gs_amm_allocator_only_mode",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets whether GS AMM should ignore predictions and use allocator-only grants."),
            NULL},
            &gs_amm_allocator_only_mode,
            false,
            NULL,
            assign_gs_amm_allocator_only_mode,
            NULL},
        {{"gs_amm_feedback_only_mode",
            PGC_SIGHUP,
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Enables prediction-free feedback-only AP scheduling for GS AMM."),
            NULL},
            &gs_amm_feedback_only_mode,
            false,
            NULL,
            assign_gs_amm_feedback_only_mode,
            NULL},
        {{"gs_amm_enabled",
            PGC_SIGHUP,
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Enables the native GS AMM controller and granule ownership enforcement."),
            NULL,
            GUC_SUPERUSER_ONLY},
            &gs_amm_enabled,
            false,
            NULL,
            assign_gs_amm_enabled,
            NULL},
        {{"gs_amm_dtree_calibration_enabled",
            PGC_SIGHUP,
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Enables native per-leaf decision-tree calibration for GS AMM."),
            NULL},
            &gs_amm_dtree_calibration_enabled,
            false,
            NULL,
            assign_gs_amm_dtree_calibration_enabled,
            NULL},
        {{"gs_amm_dtree_record_only",
            PGC_SIGHUP,
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Records GS AMM decision-tree feedback without applying calibration updates."),
            NULL},
            &gs_amm_dtree_record_only,
            true,
            NULL,
            assign_gs_amm_dtree_record_only,
            NULL},
        {{"gs_amm_legacy_control_enabled",
            PGC_SIGHUP,
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Allows external legacy or debug SQL to mutate GS AMM state."),
            gettext_noop("Normal native AMM operation is driven by executor and pagewriter paths and keeps this disabled.")},
            &u_sess->attr.attr_storage.gs_amm_legacy_control_enabled,
            false,
            NULL,
            NULL,
            NULL},
        {{"gs_amm_native_auto_mode",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets whether GS AMM automatically manages eligible executor queries."),
            NULL},
            &gs_amm_native_auto_mode,
            false,
            NULL,
...
static void InitStorageConfigureNamesInt()
{
    struct config_int localConfigureNamesInt[] = {
        ...
        {{"shared_buffers",
            ...
            NULL,
            NULL},
        {{"gs_amm_shared_buffers_min_mb",
            PGC_SIGHUP,
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the lower bound for GS AMM shared buffers."),
            gettext_noop("The controller will not intentionally shrink active shared buffers below this size.")},
            &gs_amm_shared_buffers_min_mb,
            64,
            1,
            INT_MAX / 2,
        ...
        {{"gs_amm_controller_horizon",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the planning horizon for the GS AMM controller."),
            NULL},
            &gs_amm_controller_horizon,
            3,
            1,
        ...
        {{"gs_amm_resize_rate_limit_mb",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the per-decision shared-buffer resize limit for GS AMM."),
            NULL},
            &gs_amm_resize_rate_limit_mb,
            64,
            1,
        ...
        {{"gs_amm_tp_pressure_guard",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the TP pressure threshold that forces GS AMM protection."),
            NULL},
            &gs_amm_tp_pressure_guard,
            80,
            1,
        ...
        {{"gs_amm_io_pressure_guard",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the IO pressure threshold that forces GS AMM protection."),
            NULL},
            &gs_amm_io_pressure_guard,
            80,
            1,
        ...
        {{"gs_amm_deadband_mb",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the deadband used by the GS AMM controller."),
            NULL},
            &gs_amm_deadband_mb,
            32,
            0,
        ...
        {{"gs_amm_ap_min_grant_mb",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the minimum AP memory grant admitted by GS AMM."),
            NULL},
            &gs_amm_ap_min_grant_mb,
            4,
            1,
        ...
        {{"gs_amm_fallback_work_mem_kb",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the native work_mem cap used when GS AMM admission falls back."),
            NULL,
        ...
        {{"gs_amm_ap_queue_limit",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the AP backpressure queue limit for GS AMM."),
            NULL},
            &gs_amm_ap_queue_limit,
            16,
            0,
        ...
        {{"gs_amm_ap_queue_timeout_ms",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the AP backpressure queue timeout for GS AMM."),
            NULL,
            GUC_UNIT_MS},
            &gs_amm_ap_queue_timeout_ms,
            5000,
        ...
        {{"gs_amm_resize_observe_window_ms",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the post-resize observation window for GS AMM."),
            NULL,
            GUC_UNIT_MS},
            &gs_amm_resize_observe_window_ms,
            5000,
        ...
        {{"gs_amm_resize_cooldown_ms",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the resize cooldown for GS AMM."),
            NULL,
            GUC_UNIT_MS},
            &gs_amm_resize_cooldown_ms,
            8000,
        ...
        {{"gs_amm_resize_batch_mb",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the maximum shared-buffer resize amount per GS AMM controller round."),
            NULL},
            &gs_amm_resize_batch_mb,
            64,
            1,
        ...
        {{"gs_amm_granule_size_mb",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the fixed GS AMM ownership granule size."),
            gettext_noop("This value determines the shared-memory granule table layout at postmaster start.")},
            &gs_amm_granule_size_mb,
            64,
            1,
            INT_MAX / 2,
        ...
        {{"gs_amm_tp_recovery_cooldown_ms",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the TP recovery cooldown for GS AMM."),
            NULL,
            GUC_UNIT_MS},
            &gs_amm_tp_recovery_cooldown_ms,
            8000,
        ...
        {{"gs_amm_allocator_only_grant_mb",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the fixed AP grant target used in allocator-only mode for GS AMM."),
            NULL},
            &gs_amm_allocator_only_grant_mb,
            128,
            1,
            INT_MAX / 2,
            NULL,
            assign_gs_amm_allocator_only_grant_mb,
            NULL},
        {{"gs_amm_feedback_bootstrap_grant_mb",
            PGC_SIGHUP,
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the initial feedback-only AP grant in megabytes."),
            NULL},
            &gs_amm_feedback_bootstrap_grant_mb,
            64,
            1,
            INT_MAX / 2,
            NULL,
            assign_gs_amm_feedback_config,
            NULL},
        {{"gs_amm_feedback_max_grant_mb",
            PGC_SIGHUP,
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the feedback-only AP grant ceiling in megabytes."),
            NULL},
            &gs_amm_feedback_max_grant_mb,
            256,
            1,
        ...
        {{"gs_amm_feedback_initial_ap_slots",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the initial AP concurrency slots in feedback-only mode."),
            NULL},
            &gs_amm_feedback_initial_ap_slots,
            1,
            1,
        ...
        {{"gs_amm_feedback_max_ap_slots",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the AP concurrency slot ceiling in feedback-only mode."),
            NULL},
            &gs_amm_feedback_max_ap_slots,
            4,
            1,
        ...
        {{"gs_amm_feedback_stable_windows",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets successful completions required before feedback-only growth."),
            NULL},
            &gs_amm_feedback_stable_windows,
            2,
            1,
        ...
        {{"gs_amm_feedback_spill_threshold_mb",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets spill volume that triggers feedback-only AP backoff."),
            NULL},
            &gs_amm_feedback_spill_threshold_mb,
            32,
            0,
...
static void InitStorageConfigureNamesReal()
{
    struct config_real localConfigureNamesReal[] = {
        ...
        {{"gs_amm_tp_jitter_limit",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the TPS drop ratio that activates GS AMM hard protection."),
            NULL},
            &gs_amm_tp_jitter_limit,
            0.03,
            0.0,
        ...
        {{"gs_amm_native_ap_cost_threshold",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the minimum plan cost for native GS AMM AP eligibility."),
            NULL},
            &gs_amm_native_ap_cost_threshold,
            10000.0,
            0.0,
...
static void InitStorageConfigureNamesEnum()
{
    struct config_enum localConfigureNamesEnum[] = {
        ...
        {{"gs_amm_admission_failure_policy",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets whether native GS AMM admission failures use capped fallback or return an error."),
            NULL,
            GUC_SUPERUSER_ONLY},
            &gs_amm_admission_failure_policy,
            GS_AMM_ADMISSION_FALLBACK,
            gs_amm_admission_failure_policy_options,
            NULL,
            NULL,
            NULL},
        {{"wal_level",
...
{
    return AmPostmasterProcess();
}

static void assign_gs_amm_enabled(bool newval, void *extra)
{
    (void)extra;
    gs_amm_enabled = newval;
    if (!gs_amm_shared_config_owner())
        return;
    GsAmmOnRuntimeConfigGucReload(gs_amm_allocator_only_mode, gs_amm_allocator_only_grant_mb,
        gs_amm_dtree_calibration_enabled, gs_amm_dtree_record_only);
    GsAmmOnEnabledGucChange(newval);
}

static void assign_gs_amm_allocator_only_mode(bool newval, void *extra)
{
    (void)extra;
    gs_amm_allocator_only_mode = newval;
    if (!gs_amm_shared_config_owner())
        return;
    GsAmmOnRuntimeConfigGucReload(newval, gs_amm_allocator_only_grant_mb,
        gs_amm_dtree_calibration_enabled, gs_amm_dtree_record_only);
}
...
{
    (void)extra;
    gs_amm_feedback_only_mode = newval;
    if (!gs_amm_shared_config_owner())
        return;
    GsAmmOnFeedbackConfigGucReload(newval, gs_amm_feedback_bootstrap_grant_mb,
        gs_amm_feedback_max_grant_mb, gs_amm_feedback_initial_ap_slots,
        gs_amm_feedback_max_ap_slots, gs_amm_feedback_stable_windows,
        gs_amm_feedback_spill_threshold_mb);
}
...
{
    (void)extra;
    gs_amm_dtree_calibration_enabled = newval;
    if (!gs_amm_shared_config_owner())
        return;
    GsAmmOnRuntimeConfigGucReload(gs_amm_allocator_only_mode, gs_amm_allocator_only_grant_mb,
        newval, gs_amm_dtree_record_only);
}

static void assign_gs_amm_dtree_record_only(bool newval, void *extra)
{
    (void)extra;
    gs_amm_dtree_record_only = newval;
    if (!gs_amm_shared_config_owner())
        return;
    GsAmmOnRuntimeConfigGucReload(gs_amm_allocator_only_mode, gs_amm_allocator_only_grant_mb,
        gs_amm_dtree_calibration_enabled, newval);
...
{
    (void)extra;
    gs_amm_allocator_only_grant_mb = newval;
    if (!gs_amm_shared_config_owner())
        return;
    GsAmmOnRuntimeConfigGucReload(gs_amm_allocator_only_mode, newval,
        gs_amm_dtree_calibration_enabled, gs_amm_dtree_record_only);
}
...
static void assign_gs_amm_feedback_config(int newval, void *extra)
{
    ...
    if (!gs_amm_shared_config_owner())
        return;
    GsAmmOnFeedbackConfigGucReload(gs_amm_feedback_only_mode, gs_amm_feedback_bootstrap_grant_mb,
        gs_amm_feedback_max_grant_mb, gs_amm_feedback_initial_ap_slots,
        gs_amm_feedback_max_ap_slots, gs_amm_feedback_stable_windows,
        gs_amm_feedback_spill_threshold_mb);
}
