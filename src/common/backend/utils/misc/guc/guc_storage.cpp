...
static const struct config_enum_entry gs_amm_workload_role_options[] = {
    {"tp", GS_AMM_WORKLOAD_TP, false},
    {"ap", GS_AMM_WORKLOAD_AP, false},
    {NULL, 0, false}
};
...
static void InitStorageConfigureNamesBool()
{
    struct config_bool localConfigureNamesBool[] = {
        ...
        {{"gs_amm_enabled",
            ...
            NULL},
        {{"gs_amm_tp_test_worker_surge",
            PGC_USERSET,
            NODE_ALL,
            DEVELOPER_OPTIONS,
            gettext_noop("Enables a worker-rate TP pressure trigger for GS AMM acceptance tests."),
            gettext_noop("For test use only.  When disabled, TP-priority recovery is triggered only by host CPU pressure.")},
            &gs_amm_tp_test_worker_surge,
            false,
            NULL,
            NULL,
        ...
        {{"gs_amm_tp_test_mode",
            ...
            NODE_ALL,
            DEVELOPER_OPTIONS,
            gettext_noop("Enables isolated GS AMM acceptance-test pressure mode."),
            gettext_noop("For test use only.  Suppresses host CPU pressure so the test worker-surge marker controls recovery.")},
            &gs_amm_tp_test_mode,
            false,
            NULL,
            NULL,
        ...
        {{"gs_amm_test_ap_use_labels",
            ...
            NODE_ALL,
            DEVELOPER_OPTIONS,
            gettext_noop("Enables explicit AP label overrides for GS AMM tests."),
...
static void InitStorageConfigureNamesInt()
{
    struct config_int localConfigureNamesInt[] = {
        ...
        {{"gs_amm_shared_buffers_min_mb",
            ...
            NULL,
            NULL},
        {{"gs_amm_tp_reserve_mb",
            PGC_SIGHUP,
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Reserves additional shared-buffer capacity for TP under GS AMM."),
            gettext_noop("AP borrowing stops at shared_buffers_min_mb plus this reserve.")},
            &gs_amm_tp_reserve_mb,
            0,
            0,
            INT_MAX / 2,
        ...
        {{"gs_amm_test_ap_cache_label_kb",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Overrides the AP cache bound for AMM acceptance tests."),
            gettext_noop("Zero keeps the normal model prediction; positive values are session-local labels in kB."),
            GUC_UNIT_KB},
            &gs_amm_test_ap_cache_label_kb,
            0,
            0,
        ...
        {{"gs_amm_test_ap_one_pass_label_kb",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Overrides the AP one-pass bound for AMM acceptance tests."),
            gettext_noop("Zero keeps the normal model prediction; positive values are session-local labels in kB."),
            GUC_UNIT_KB},
            &gs_amm_test_ap_one_pass_label_kb,
            0,
        ...
        {{"gs_amm_test_ap_multi_pass_label_kb",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Overrides the AP multi-pass bound for AMM acceptance tests."),
            gettext_noop("Zero keeps the normal model prediction; positive values are session-local labels in kB."),
            GUC_UNIT_KB},
            &gs_amm_test_ap_multi_pass_label_kb,
            0,
        ...
        {{"gs_amm_test_ap_label_kb",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Compatibility AP label for AMM acceptance tests."),
            gettext_noop("A positive value applies the same session-local label to all three AP bounds."),
            GUC_UNIT_KB},
            &gs_amm_test_ap_label_kb,
            0,
            0,
            ...
            NULL,
            NULL},
        {{"gs_amm_tp_buffer_miss_threshold_pct",
            PGC_SIGHUP,
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the TP shared-buffer miss percentage that guards AP admission."),
            gettext_noop("Zero disables the TP shared-buffer miss guard.")},
            &gs_amm_tp_buffer_miss_threshold_pct,
            5,
            0,
            100,
            ...
            NULL,
            NULL},
        {{"gs_amm_ap_borrow_buffer_hit_guard_pct",
            PGC_SIGHUP,
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the TP buffer-hit decline that stops AP shared-buffer borrowing."),
            gettext_noop("Zero disables the AP borrow buffer-hit guard; otherwise the value is a relative percentage.")},
            &gs_amm_ap_borrow_buffer_hit_guard_pct,
            3,
            0,
            100,
        ...
        {{"gs_amm_tp_tps_decline_guard_pct",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the TP TPS change guard used while recovering from CPU pressure."),
            gettext_noop("Zero disables the TPS stability guard; otherwise the value is a relative percentage from the pre-borrow TP baseline.")},
            &gs_amm_tp_tps_decline_guard_pct,
            3,
            0,
            100,
            ...
            NULL,
            NULL},
        {{"gs_amm_tp_cpu_pressure_threshold_pct",
            PGC_SIGHUP,
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the host CPU usage percentage that starts TP-priority recovery."),
            gettext_noop("At or above this value AMM stops AP, restores shared buffers, and waits for TP stability.  Zero disables CPU-pressure recovery.")},
            &gs_amm_tp_cpu_pressure_threshold_pct,
            60,
            0,
            100,
...
static void InitStorageConfigureNamesEnum()
{
    struct config_enum localConfigureNamesEnum[] = {
        {{"gs_amm_workload_role",
            PGC_USERSET,
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Classifies the current session as TP or AP for GS AMM."),
            gettext_noop("Only AP sessions use prediction admission and AP grants.")},
            &gs_amm_workload_role,
            GS_AMM_WORKLOAD_TP,
            gs_amm_workload_role_options,
            NULL,
            NULL,
            NULL},
        {{"resource_track_log",
