...
typedef struct BufferDescExtra {
    ...
    volatile uint32 amm_owner_epoch;
} BufferDescExtra;
...
extern int StrategyActiveBufferCount(void);
extern void StrategySetActiveBufferCount(int active_buffers);
