...
#define HASHJOIN_AMM_BATCH_FILE_SEGMENT_SLOTS 64
#define HASHJOIN_AMM_BATCH_FILE_SEGMENT_COUNT 64

typedef struct HashJoinBatchFileSegment {
    BufFile* inner[HASHJOIN_AMM_BATCH_FILE_SEGMENT_SLOTS];
    BufFile* outer[HASHJOIN_AMM_BATCH_FILE_SEGMENT_SLOTS];
} HashJoinBatchFileSegment;
...
typedef struct HashJoinTableData {
    ...
    bool ammBatchFileSegmentsEnabled;
    HashJoinBatchFileSegment* ammBatchFileSegments[HASHJOIN_AMM_BATCH_FILE_SEGMENT_COUNT];
...
extern bool ExecHashUsesAmmBatchFileSegments(HashJoinTable hashtable);
extern BufFile** ExecHashGetInnerBatchFileSlot(HashJoinTable hashtable, int batchno);
extern BufFile** ExecHashGetOuterBatchFileSlot(HashJoinTable hashtable, int batchno);
